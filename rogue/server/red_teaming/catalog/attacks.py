...
Attack Types:
- FREE attacks: All attacks are now implemented locally in rogue/server/red_teaming/attacks/
- PREMIUM attacks: None - all attacks have been made free

All attack techniques are now available without requiring QUALIFIRE_API_KEY.
This includes single-turn, multi-turn, and agentic attacks.
"""
...
FREE_SINGLE_TURN_ATTACKS = [
    ...
    AttackDef(
        ...
        category=AttackCategory.SINGLE_TURN,
        description="Uses visually similar Unicode characters to bypass text filters (advanced implementation)",
    ),
    AttackDef(
...
# =============================================================================
# PREMIUM SINGLE-TURN ATTACKS (None - all are now free)
# =============================================================================
...
# =============================================================================
# PREMIUM MULTI-TURN ATTACKS (None - all are now free)
# =============================================================================
...
def get_basic_scan_attacks() -> List[str]:
    ...
    Returns all free attacks (single-turn, multi-turn, and agentic).
    """
    return [
        # Encoding attacks
        ...
        AttackId.CITATION.value,
        AttackId.GCG.value,
        AttackId.LIKERT_JAILBREAK.value,
        AttackId.BEST_OF_N.value,
        # Multi-turn attacks
        AttackId.SOCIAL_ENGINEERING_PROMPT_EXTRACTION.value,
        AttackId.MULTI_TURN_JAILBREAK.value,
        AttackId.GOAT.value,
        AttackId.MISCHIEVOUS_USER.value,
        AttackId.SIMBA.value,
        AttackId.CRESCENDO.value,
        AttackId.LINEAR_JAILBREAK.value,
        AttackId.SEQUENTIAL_JAILBREAK.value,
        AttackId.BAD_LIKERT_JUDGE.value,
        # Agentic attacks
        AttackId.ITERATIVE_JAILBREAK.value,
        AttackId.META_AGENT_JAILBREAK.value,
        AttackId.HYDRA.value,
        AttackId.TREE_JAILBREAK.value,
        AttackId.SINGLE_TURN_COMPOSITE.value,
    ]
